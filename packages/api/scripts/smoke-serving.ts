...
check(
  "root page",
  resolveSiteObjectKey("/site_a"),
  "sites/site_a/index.html",
)
check(
  "root page with slash",
  resolveSiteObjectKey("/site_a/"),
  "sites/site_a/index.html",
)
check(
...
check(
  "file passthrough",
  resolveSiteObjectKey("/site_a/logo.png"),
  "sites/site_a/logo.png",
)
check(
  "deep nested",
...
check(
  "custom domain file",
  resolveRequestKey("/logo.png", "site_a"),
  "sites/site_a/logo.png",
)
check(
  "no domain match, no site in path",
  resolveRequestKey("/", null),
  null,
)
check(
