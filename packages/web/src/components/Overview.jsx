  ...
  return (
    <div className="overview">
      <section className="stat-grid">
        <div className="stat-card"><span>Published sites</span><strong>{publishedCount || (site.status === 'published' ? 1 : 0)}</strong><small><b>↗</b> connected to API</small></div>
        <div className="stat-card"><span>Site visits</span><strong>—</strong><small>coming with analytics</small></div>
        <div className="stat-card"><span>New leads</span><strong>—</strong><small>coming soon</small></div>
      </section>
      ...
      <div className="site-list-card">
        <div className="site-preview-thumb">
          <div className="thumb-header">{site.business.logo}<span>About　Services　Contact</span></div>
        ...
        <div className="site-info">
          <div className="site-info-title">
            ...
            <span className="status-pill"><i /> {site.status === 'published' ? 'Published' : 'Draft'}</span>
          </div>
          <div className="site-meta">
            <span>Edited {site.lastSaved}</span>
            <span>Editorial Studio</span>
            <button onClick={onEdit}>Edit site <Icon name="arrow" size={15} /></button>
          </div>
        </div>
      </div>
      ...
      <div className="tip-card">
        ...
        <button>View checklist <Icon name="arrow" size={15} /></button>
      </div>
    </div>
  )
}
